...
public class CerpBomStockAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request,
		...
		if(user != null) {
			...
			String selectbomstock= request.getParameter("bom");
			...
			if(grade>=2) {
				...
				ActionForward forward = new ActionForward("bom_product_select.jsp", false); //  
				return forward;
			}
			request.setAttribute("loginuser", user);
