...
public class CerpOrderInsertFinishAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request,
		...
		if(user != null) {
			...
			if(grade>=2) {
				...
				success = logina.InsertOrder(clientname,itemname,orderday,delivery_day,forwarding_price,count,total_amount,ecode,name,sv);
