...
public class CerpClientUpdateFinishAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request,
		...
		if(user != null) {
			...
			if(grade>=3) {
				...
				success = logina.UpdateClient(clientcode,clientname,representative, type_of_business, business_number, contact, representative_contact, address, representative_email);
