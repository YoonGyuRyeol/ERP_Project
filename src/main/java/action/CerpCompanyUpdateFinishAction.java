...
public class CerpCompanyUpdateFinishAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request,
		...
		if(user != null) {
			ccode= request.getParameter("companycode");
			...
			if(grade>=3) {
				...
				success = logina.UpdateCompany(ccode,cname,representative, type_of_business, business_number, contact, representative_contact, address, representative_email);
