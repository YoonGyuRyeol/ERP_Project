...
<table border="0">
      ...
      <tr>
        <td colspan="2" >
          <table border="1" cellpadding="2" cellspacing="0" width="1200" bordercolorlight="red" bordercolordark="#FFFFFF" style="border:2px solid #ff0000;">
            <tbody>
            <tr>
              <td colspan="4" align="center" height="50"><font size="6" color="red"><b>세금계산서</b></font> <font color="red">(공급자보관용)</font></td>
            </tr>
            <tr>
              <td colspan="4">
              	
                <table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolorlight="red" bordercolordark="#FFFFFF" background="./img/admin/stamp.gif" style="background-repeat:no-repeat;
                border:2px solid #ff0000">
                  <tbody>
                  <tr>
                    <td rowspan="4" width="20" align="center"><font color="red">공<br>급<br>자</font></td>
                    <td width="64"><font color="red">등록번호</font></td>
                    <td width="225" colspan="4" >174-31-77777</td>
                    <td rowspan="4" width="21" align="center"><font color="red">공<br>급<br>받<br>는<br>자</font></td>
                    <td width="62"><font color="red">등록번호</font></td>
                    <td width="264" colspan="4"><c:out value='${order.clientcode}'/></td>
                  </tr>
                  
                  <tr>
                    <td width="64"><font color="red">상 호<br>(법인명)</font></td>
                    <td colspan="2" width="106">CerpPC</td>
                    <td width="19"><font color="red">성<br>명</font></td>
                    <td width="88">윤대표</td>
                    <td width="62"><font color="red">상 호<br>(법인명)</font></td>
                    <td colspan="2" width="133"><c:out value='${order.clientname}'/></td>
                    <td width="19"><font color="red">성<br>명</font></td>
                    <td width="100"><c:out value='${order.representative}'/></td>
                  </tr>
                  
                  <tr>
                    <td width="64"><font color="red">사업장<br>주 소</font></td>
                    <td colspan="4" width="225">&nbsp;서울시 은평구</td>
                    <td width="62"><font color="red">사업장<br>주 소</font></td>
                    <td colspan="4" width="264"><c:out value='${order.address}'/></td>
                  </tr>
                  <tr>
                    <td width="64"><font color="red">업 태</font></td>
                    <td width="82">제조업</td>
                    <td width="18"><font color="red">종<br>목</font></td>
                    <td colspan="2" width="113">서비스</td>
                    <td width="62"><font color="red">업 태</font></td>
                    <td width="109"><c:out value='${order.type_of_business}'/></td>
                    <td width="18"><font color="red">종<br>목</font></td>
            ...
            <tr>
              <td align="center" height="25"><font color="red">작 &nbsp;&nbsp;성</font></td>
              <td align="center"><font color="red">공 &nbsp;&nbsp;급 &nbsp;&nbsp;가&nbsp;&nbsp;액</font></td>
              <td align="center"><font color="red">세 &nbsp;&nbsp;액</font></td>
              <td align="center"><font color="red">비 &nbsp;&nbsp;고</font></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="4" height="86">
                <table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolorlight="red" bordercolordark="#FFFFFF" style="border:2px solid #ff0000">
                  <tbody><tr align="center">
                    <td><font color="red">월</font></td>
                    <td><font color="red">일</font></td>
                    <td><font color="red">품 목</font></td>
                    <td><font color="red">규 격</font></td>
                    <td><font color="red">수 량</font></td>
                    <td><font color="red">단 가</font></td>
                    <td><font color="red">공 급 가 액</font></td>
                    <td><font color="red">세 액</font></td>
                    <td><font color="red">비 고</font></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="right"><c:out value='${order.forwarding_price}'/></td>
            ...
            <tr>
              <td colspan="4">
                <table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolorlight="red" bordercolordark="#FFFFFF" style="border:2px solid #ff0000">
                  <tbody><tr align="center">
                    <td><font color="red">합 계 금 액</font></td>
                    <td><font color="red">현 금</font></td>
                    <td><font color="red">수 표</font></td>
                    <td><font color="red">어 음</font></td>
                    <td><font color="red">외 상 미 수 금</font></td>
                    <td rowspan="2" width="120" align="center"><font color="red">이 금액을 영수 함.<br></font></td>
                  </tr>
                  <tr align="center">
...
<div id="capture">
<div class="divmargin">
<table border="0" style="margin:1px;">
      <tbody>
      <tr>
        <td colspan="2" >
