...
<form action="CerpWhRefundUpdateOneFinish.Capt" method="post">
...
<tbody>
	...
	반품 처리 개수 <input type="number" min="0" max=${max} name="count" id="countd" value=0  onkeyup="totalmax()" onchange="totalmax()">
	<button type="submit" id="submit2" class="btsize" name="action" value="delete" >반품 처리 완료하기</button><br>
	</form>
...
function totalmax()
{
  ...
  if(max < (parseInt(count))){
		alert('현재 불량품의 개수를 넘어서는 값은 입력 할 수 없습니다.');
