...
<div id="capture">
<div class="divmargin wrap-vertical">
<table border="0">
      <tbody>
      <tr>
        <td colspan="2" >
          <table border="1" cellpadding="2" cellspacing="0" width="1050" bordercolorlight="blue" bordercolordark="#FFFFFF" style="border:2px solid #0000ff;">
            <tbody>
            <tr>
              ...
              <td colspan="4">
                <table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolorlight="blue" bordercolordark="#FFFFFF" background="./img/admin/stamp.gif" style="background-repeat:no-repeat;">
                  ...
                  <tr>
                    ...
                    <td colspan="2" width="133"><input type="text"  name="clientname" id="clientname"  value=${order.clientname} readonly></td>
                    <td width="19"><font color="blue">성<br>명</font></td>
                    <td width="100">&nbsp;</td>
                  </tr>
                  <tr>
...
<button onclick="abc()" id="savePdf" >PDF 저장버튼3</button>
