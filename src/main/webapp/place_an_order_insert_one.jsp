...
<form action="CerpPoTempUpdateOneFinish.Capt" method="post">
...
<table cellspacing="0" cellpadding="0">
	...
	<div style="color:red;">부품코드 : <input type="text"  name="itemcode" id="" value='${temp.itemcode}' readonly></div>
	<div style="color:red;">부품명 : <input type="text"  name="itemname" id="" value='${temp.itemname}' readonly></div>
	<div>거래처명 : <input type="text"  name="clientname" id="clientname" value=${temp.clientname} readonly></div>
	...
	부품개수 : <input type="text"  name="count" id="" value=${temp.count}> <br>

	<button type="submit" id="submit2" class="btsize" name="action" value="update" >수정하기</button><br>
	</form>
