...
<form action="CerpBomUpdateOneFinish.Capt" method="post">
	<div style="color:red;"> 원래 부품 코드 : <input type="text" placeholder="bom_stock_code" name="o_itemcode" id="" value=${itemcode} readonly> </div> 
	<div style="color:red;"> 원래 부품 명 : <input type="text" placeholder="bom_stock_code" name="itemname" id="" value='${itemname}' readonly> </div>
	필요한 부품 수 : <input type="text" placeholder="bom_stock_code" name="materials" id="" value=${materials}>
