...
<form action="CerpWhRefundTempUpdateOneFinish.Capt" method="post">
...
<tbody>
	...
	<button type="submit" id="submit2" class="btsize" name="action" value="delete" >반품 가입고 처리 완료하기</button><br>
	</form>
...
function totalmax()
{
  ...
  if(max < (parseInt(count))){
		alert('반품한 개수를 넘어서는 값은 입력 할 수 없습니다.');
